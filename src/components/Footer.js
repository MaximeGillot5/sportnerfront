        ...
        <div id='footer-right' className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-center space-x-3">
              <a rel="noopener noreferrer" target='_blank' href="https://github.com/MaximeGillot5/sportner" title="GitHub" className="flex items-center p-1">
                <i id='icons' className="fa-brands fa-square-github"></i>
              </a>
              <a rel="noopener noreferrer" target='_blank' href="https://twitter.com/FrancsJeux" title="Twitter" className="flex items-center p-1">
              ...
              <a rel="noopener noreferrer" target='_blank' href="https://www.instagram.com/jeuxolympiques/" title="Instagram" className="flex items-center p-1">
